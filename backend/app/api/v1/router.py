...
from app.api.v1.endpoints import clientes, validaciones, auth, admin, contacto, dashboard, templates, documentos, constancias, verificaciones, reportes, cursos, participantes, dashboard_kpi, verificar, public as public_endpoints, plantillas_pdf, archivos, cupo, stripe_payments, notificaciones, catalogo, organizaciones
...
api_router.include_router(cupo.router, prefix="/cupo", tags=["cupo"])
