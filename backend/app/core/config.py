...
class Settings(BaseSettings):
    ...
    # Database settings
    DATABASE_URL: str = os.getenv("DATABASE_URL", "postgresql://user:***@localhost/aaces_db")
    ...
    # Platform / Demo credentials (Phase 1)
    PLATFORM_USER_EMAIL: str = os.getenv("PLATFORM_USER_EMAIL", "admin@aaces.com")
    PLATFORM_USER_PASSWORD: str = os.getenv("PLATFORM_USER_PASSWORD", "supersecurepassword123")
    PLATFORM_USER_NAME: str = os.getenv("PLATFORM_USER_NAME", "Super Admin")
    DEMO_ORG_RFC: str = os.getenv("DEMO_ORG_RFC", "AAC123456789")
    DEMO_ORG_NAME: str = os.getenv("DEMO_ORG_NAME", "AACES Demo")
    DEMO_ORG_ADMIN_EMAIL: str = os.getenv("DEMO_ORG_ADMIN_EMAIL", "admin@demo.com")
    DEMO_ORG_ADMIN_PASSWORD: str = os.getenv("DEMO_ORG_ADMIN_PASSWORD", "demo123")
    DEMO_ADMIN_NAME: str = os.getenv("DEMO_ADMIN_NAME", "Administrador")
