...
export default function CtaSection() {
  return (
    <section className="px-6 py-12 md:py-20">
      <Reveal scale={0.97} className="relative mx-auto max-w-5xl overflow-hidden rounded-3xl bg-orange-500 px-6 py-14 text-center text-white shadow-2xl shadow-orange-500/20 sm:px-12 md:py-16">
        ...
        <div className="relative">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              ...
              className="group inline-flex w-full items-center justify-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-orange-500 shadow-lg transition-all duration-200 hover:bg-orange-50 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-orange-500 sm:w-auto"
            >
              Comenzar gratis
